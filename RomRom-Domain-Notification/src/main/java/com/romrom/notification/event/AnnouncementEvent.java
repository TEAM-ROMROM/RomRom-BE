...
public class AnnouncementEvent {
  ...
  public AnnouncementEvent(UUID announcementId, String announcementTitle) {
    ...
    this.title = NotificationType.SYSTEM_NOTICE.getTitle();
    this.body = String.format(NotificationType.SYSTEM_NOTICE.getBody(), announcementTitle);

    this.payload = new HashMap<>();
    this.payload.put("notificationType", NotificationType.SYSTEM_NOTICE.name());
